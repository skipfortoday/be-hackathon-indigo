...
router.post('/', async function(req, res, next) {
    try {
          ...
          let resultShortener = await axios.post(apiShortener.url, dataShortener, apiShortener.config )
          ...
          let resultSMS = await axios.post(apiSMS.url, dataSMS, apiShortener.config )    
